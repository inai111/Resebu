...
<head>
    ...
    <link href="{{ URL::asset('https://cdn.jsdelivr.net/npm/simple-datatables@latest/dist/style.css') }}" rel="stylesheet" />
    <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.0.1/css/bootstrap.min.css" 
     rel="stylesheet" /> 
    <link href="{{ URL::asset('css/styles.css') }}" rel="stylesheet" />
    <link href="{{ URL::asset('css/trix.css') }}" rel="stylesheet" />
    <link href="{{ URL::asset('https://cdn.datatables.net/1.11.3/css/dataTables.bootstrap5.min.css') }}" rel="stylesheet" />
    <script src="https://code.jquery.com/jquery-3.5.1.js" crossorigin="anonymous"></script>
    <script src="{{ URL::asset('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/js/all.min.js') }}" crossorigin="anonymous"></script>
    <style>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav border-bottom navbar navbar-expand navbar-light bg-light">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="/">!Resebu!<img src="assets/img/hat.png" class="img-fluid pb-3" style="width: 30px" alt=""></a>
        <!-- Sidebar Toggle-->
        <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
        <!-- Navbar Search-->
        <form method="post" action="/pencarian" class="d-none d-md-inline-block form-inline ms-auto w-50 me-0 me-md-3 my-2 my-md-0">
            @csrf
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                ...
                <div class="sb-sidenav-footer bg-secondary">
                    ...
                    <small class="text-dark">{{ auth()->user()->nama }} <img src="{{ URL::asset('assets/img/hat.png') }}" class="img-fluid pb-3" style="width: 20px" alt=""></small>
                </div>
            </nav>
        </div>
